...
const PERU: CountryData = {
  ...
  climate: {
    ...
    tBandLow: [11.8, 12.2, 11.9, 10.5, 8.1, 6.3, 5.4, 5.7, 6.8, 8.2, 9.5, 10.9],
    tBandHigh: [32.4, 33.1, 32.7, 31.2, 29.3, 28.1, 27.3, 27.6, 28.2, 29.1, 30.3, 31.7],
    r: PERU_RAIN,
    ...
    wBandLow: [5.6, 5.9, 6.1, 5.7, 5.4, 5.6, 5.8, 6.2, 6.5, 6.3, 6.0, 5.8],
    wBandHigh: [17.3, 18.4, 18.9, 17.7, 16.7, 17.2, 18.0, 19.0, 20.1, 19.6, 18.5, 17.8],
  },
  regions: [
...
const JAPAN: CountryData = derive({
  ...
  climate: {
    ...
    tBandLow: [-2.8, -2.6, 0.1, 5.3, 10.1, 14.6, 18.9, 20.1, 16.2, 10.6, 4.9, -0.3],
    tBandHigh: [13.8, 14.4, 18.0, 23.2, 27.2, 29.6, 32.8, 34.4, 30.8, 25.8, 20.7, 15.8],
    r: JAPAN_RAIN,
    ...
    wBandLow: [6.1, 6.3, 6.6, 6.7, 6.4, 6.1, 6.3, 6.5, 6.7, 6.4, 6.1, 5.9],
    wBandHigh: [18.7, 19.4, 20.4, 20.7, 19.7, 18.7, 19.4, 20.1, 20.7, 19.7, 18.7, 18.4],
  },
  regions: [],
  advisories: {
...
const ICELAND: CountryData = derive({
  ...
  climate: {
    ...
    tBandLow: [-8.1, -7.6, -7.0, -5.2, -1.6, 1.8, 4.2, 3.8, 1.0, -2.2, -5.6, -7.8],
    tBandHigh: [7.4, 7.8, 8.4, 11.2, 15.1, 18.2, 19.8, 19.2, 16.4, 12.6, 9.4, 7.6],
    r: ICELAND_RAIN,
    ...
    wBandLow: [12.3, 12.0, 11.7, 10.8, 9.8, 9.0, 8.7, 8.9, 10.1, 11.1, 11.8, 12.2],
    wBandHigh: [38.1, 37.1, 36.0, 33.3, 30.3, 27.9, 26.9, 27.5, 31.3, 34.2, 36.4, 37.7],
  },
  regions: [],
